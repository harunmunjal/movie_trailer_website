...
avatar = media.Movie("Avatar", "A marine on an alien planet",
                     ...
                     "https://www.youtube.com/watch?v=5PSNL1q" +
                     "E6VY")
...
theory_of_everything = media.Movie("Theory Of Everything",
                                   "A look at the life of renowned scientist Stephen Hawking"+
                                   "and his love affair with Jane. He was diagnosed with the"+
                                   "motor neuron disease but that didn't stop him from becoming"+
                                   "a brilliant mind.",
                                   "http://t0.gstatic.com/images?q=tbn:ANd9GcSgW7hpezP5xtikV7Wqwwq"+
                                   "Fm37kqMeJeFEGpYcO30CDcchn9g8m",
                                   "https://www.youtube.com/watch?v=Salz7uGp72c")
znmd = media.Movie("Zindagi Na Milegi Dobara",
                   "Friends Kabir, Imran and Arjun take a"+
                   "vacation in Spain before Kabir's marriage."+
                   "The trip turns into an opportunity to mend fences,"+
...
# Array of movies object is created
